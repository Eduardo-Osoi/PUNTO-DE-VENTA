...
if(isset($_POST['submit'])){
   ...
   if($select_user->rowCount() > 0){
      $message[] = 'El correo o el numero ya existe!';
   }else{
      if($pass != $cpass){
...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="number" name="number" required placeholder="Ingrese su numero" class="box" min="0" max="9999999999" maxlength="10">
      ...
      <input type="submit" value="Registrarse ahora" name="submit" class="btn">
