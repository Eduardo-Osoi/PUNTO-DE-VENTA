...
<head>
   ...
   <title>POP Punto de venta</title>
   <link rel="icon" href="./images/pop4.png">
      ...
      <div class="swiper-wrapper">
         ...
         <div class="swiper-slide slide">
            <div class="content">
               ...
               <h3>Alimentos para el alma</h3>
               <a href="menu.php" class="btn">Ver menu</a>
            </div>
            <div class="image">
               <img src="images/alitas.png" alt="">
            </div>
         </div>
...
<section class="category">
   ...
   <h1 class="title">Categoria de alimentos</h1>
...
<section class="products">
   ...
   <h1 class="title">Ultimos platillos</h1>
