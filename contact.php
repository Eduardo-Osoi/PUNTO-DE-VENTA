...
<section class="contact">
   ...
   <div class="row">
      ...
      <form action="" method="post">
         ...
         <input type="number" name="number" min="0" max="9999999999" class="box" placeholder="Numero" required maxlength="10">
         <input type="email" name="email" maxlength="50" class="box" placeholder="Correo" required>
